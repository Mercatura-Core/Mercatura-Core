...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mercatura: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a mercatura: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list of available command-line options").arg(CLIENT_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to the Mercatura network.", "", count);
    } else {
        //: A substring of the tooltip.

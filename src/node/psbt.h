 ...
 */
struct PSBTAnalysis {
    std::optional<size_t> estimated_vsize;      //!< Estimated BIP141 virtual size of the transaction
    std::optional<CFeeRate> estimated_feerate;  //!< Estimated Mercatura feerate using full serialized fee size

...
std::vector<RPCResult> DecodeTxDoc(const std::string& txid_field_doc, bool wallet)
{
    return {
        ...
        {RPCResult::Type::NUM, "vsize", "The Mercatura effective transaction size without witness discount (equals size in this context)"},
        {RPCResult::Type::NUM, "weight", "The transaction's witness-weight value; Mercatura vsize is not derived from weight/4"},

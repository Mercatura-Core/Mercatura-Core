...
{
    // Windows:
    // Windows: C:\Users\Username\AppData\Local\Mercatura
    // macOS: ~/Library/Application Support/Mercatura
    // Unix-like: ~/.mercatura
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_LOCAL_APPDATA) / "Mercatura";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    // macOS
    return pathRet / "Library/Application Support/Mercatura";
#else
    // Unix-like
    return pathRet / ".mercatura";
#endif
#endif
}

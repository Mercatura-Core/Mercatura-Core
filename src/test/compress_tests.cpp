...
// Raw Mercatura base-unit values 1 .. 100000.
#define NUM_MULTIPLES_BASE_UNIT 100000

// Whole MCA amounts 1 .. 10000.
#define NUM_MULTIPLES_MCA 10000

// Multiples of 50 MCA through 21,000,000 MCA.
#define NUM_MULTIPLES_50_MCA 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(            10 * CENT,        0x2));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_MCA; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50_MCA; i++)

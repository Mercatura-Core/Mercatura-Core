...
/** Mercatura PQ Authorization v1 witness-v2 key commitment. */
struct WitnessV2MercaturaPQ : public BaseHash<uint256>
{
    WitnessV2MercaturaPQ() : BaseHash() {}
    explicit WitnessV2MercaturaPQ(const uint256& commitment) : BaseHash(commitment) {}
};
 ...
 *  * WitnessV2MercaturaPQ: TxoutType::WITNESS_V2_MERCATURA_PQ destination
 *  * PayToAnchor: TxoutType::ANCHOR destination (P2A address)
 *  * WitnessUnknown: TxoutType::WITNESS_UNKNOWN destination (P2W??? address)
 *  A CTxDestination is the internal data type encoded in a Mercatura address
 */
using CTxDestination = std::variant<CNoDestination, PubKeyDestination, PKHash, ScriptHash, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessV1Taproot, WitnessV2MercaturaPQ, PayToAnchor, WitnessUnknown>;

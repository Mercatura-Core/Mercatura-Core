...
public:
    CMainParams() {
        ...
        // Mercatura has no inherited Bitcoin historical script exceptions.
        consensus.BIP34Height = 1; // Active from the first post-genesis block.
        consensus.BIP34Hash = uint256{};
        consensus.BIP65Height = 1; // Active from the first post-genesis block.
        consensus.BIP66Height = 1; // Active from the first post-genesis block.

...
ADDRESS_MCRT1_UNSPENDABLE = 'mcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqp9rvcx'
ADDRESS_MCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(mcrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqp9rvcx)#afjea95d'
...
def create_deterministic_address_bcrt1_p2tr_op_true(explicit_internal_key=None):
    ...
    if explicit_internal_key is None:
        assert_equal(address, 'mcrt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqsf4z42f')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("mca" if main else "mcrt", version, program)
...
def bech32_to_bytes(address):
    ...
    if hrp not in ['mca', 'tmca', 'mcrt', 'bc', 'tb', 'bcrt']:
        return (None, None)

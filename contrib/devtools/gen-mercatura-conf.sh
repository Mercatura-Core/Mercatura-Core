...
BITCOIND=${BITCOIND:-$BINDIR/mercaturad}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/mercatura.conf}
...
then
  ...
  echo -e "To safely generate a mercatura.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example mercatura.conf file in share/examples/'
...
##
## mercatura.conf configuration file.
## Generated by contrib/devtools/gen-mercatura-conf.sh.
##

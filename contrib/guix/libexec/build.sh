...
(
    ...
    (
        ...
        # copy over the example mercatura.conf file. if contrib/devtools/gen-mercatura-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/mercatura.conf" "${DISTNAME}/"
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/mercatura-macos-app.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
